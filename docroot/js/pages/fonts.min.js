...
new simpleDatatables.DataTable("#fonts",{locale:"ca",paging:!1,labels:{noResults:"No s'ha trobat cap resultat"},columns:[{select:2,sort:"asc"}],tableRender:(a,e,s)=>{if("print"===s)return e;const t=e.childNodes[0],l={nodeName:"TR",childNodes:t.childNodes[0].childNodes.map(((a,e)=>({nodeName:"TH",childNodes:[{nodeName:"INPUT",attributes:{class:"datatable-input",type:"search","data-columns":`[${e}]`,"data-and":!0}}]})))};return t.childNodes.push(l),e}});
