...
<head>
    ...
    <style>
        ...
        details { color: yellowgreen; cursor: pointer; } details * { color: #dbdbdb; cursor: auto; }
    </style>
</head>
<body>
...
Monitorització:
<ul>
    <?php echo function_exists('apcu_enabled') && apcu_enabled() ? '<li><a href="?apc">APCu</a></li>' : '<li><b>Atenció!</b> APCu no està habilitat, el rendiment de la pàgina es veurà afectat molt significativament.</li>'; ?>
    <?php echo function_exists('opcache_get_status') && is_array(opcache_get_status()) ? '<li><a href="?opcache">OPcache</a></li>' : '<li><b>Atenció!</b> OPcache no està habilitat, el rendiment de la pàgina es veurà afectat significativament.</li>'; ?>
